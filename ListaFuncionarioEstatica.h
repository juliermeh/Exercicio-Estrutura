...
//ListaFuncionarioEstatica* lista_cria(int);

/* Função insere no inicio - Insere um Novo Funcionário no inicio da Lista */
//ListaFuncionarioEstatica* lista_insere_inicio(ListaFuncionarioEstatica* list, Funcionario* func);

/* Função busca- busca um Funcionario na lista */
//Funcionario* busca(ListaFuncionarioEstatica* lst, int v);

/* Função Lista Vazia- Testa de a Lista está vazia  */
//int lista_vazia(ListaFuncionarioEstatica* list);

/* Função Remove - Remove um Funcionário da Lista */
//ListaFuncionarioEstatica* lista_remove(ListaFuncionarioEstatica* list, int val);
